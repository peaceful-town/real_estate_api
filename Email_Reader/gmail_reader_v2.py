        ...
        for i in range(latest_email_id,first_email_id, -1):
            ...
            for response_part in data:
                ...
                if isinstance(arr, tuple):
                    ...
                    fwd_email = msg.as_string() # This makes me close. It outputs it as text, but not the original formal.
                    # print(msg.keys())
                    ...
                    if now-timedelta(hours=24) <= email_date <= now+timedelta(hours=24): # is within 24 hours of 07:00:
                        for item in emails_to_fwd:
                            if item in email_from:
                                # print(type(msg))
                                email_fwd(fwd_email, email_subject)
                                # print(fwd_email)
                                # print(item + '\n \n')
                                # print(email_subject)
